class Game {
    ...
    start() {
      ...
      box1 = createSprite(width / 2 - 50, height - 100);
      box1.addImage("car1", car1_img);
      box1.scale = 0.07;
  
      box2 = createSprite(width / 2 + 100, height - 100);
      box2.addImage("car2", car2_img);
      box2.scale = 0.07;
  
      boxes = [box1, box2];
  
      
      laserPowerup = new Group();
      coin = new Group();
      spikePlatform = new Group(); 
      platform = new Group();
